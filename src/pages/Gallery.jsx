...
const Gallery = () => {
  ...
  const fetchGalleryImages = async () => {
    try {
      ...
      const response = await axiosInstance.get('/gallery/images', {
        params: {
          isActive: 'true', // Only fetch active images for public gallery
          sortBy: 'date',
          sortOrder: 'desc'
        }
      });
  ...
  const fetchCategories = async () => {
    try {
      ...
      // Fallback: extract categories from images if API fails
      if (images.length > 0) {
  ...
  // Handle image view tracking (optional - you can remove if not needed)
  const handleImageView = async (imageId) => {
    try {
      // This would increment view count if you want to track it
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-pink-50 to-blue-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600 font-light">Loading beautiful memories...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-pink-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-light text-gray-800 mb-2">Gallery Unavailable</h2>
      ...
      <section className="relative py-20 px-4 bg-gradient-to-r from-pink-100 via-rose-50 to-orange-50 overflow-hidden mt-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl font-light text-gray-600 max-w-2xl mx-auto">
            Discover our collection of captured moments, each telling a unique story 
            of love, joy, and life's most precious memories.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600 font-light">
            ...
            {activeCategory !== 'all' && (
              <span> in <span className="font-medium capitalize">{activeCategory}</span> category</span>
            )}
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 pb-16">
        {filteredImages.length === 0 ? (
          <div className="text-center py-16">
            <Camera className="w-16 h-16 text-gray-400 mx-auto mb-4" />
            <h3 className="text-xl font-light text-gray-600 mb-2">No images found</h3>
          ...
          <LightGallery
            ref={lightGalleryRef}
            speed={500}
            plugins={[lgThumbnail, lgZoom, lgFullscreen, lgShare, lgAutoplay, lgPager, lgRotate]}
            mode="lg-fade"
            thumbnail={true}
            download={false}
          ...
          >
            {/* Masonry Layout using Tailwind CSS columns */}
            <div 
              className={
                viewMode === 'masonry'
              ...
              {filteredImages.map((image, index) => (
                <a
                  ...
                  data-sub-html={`
                    <div class="lg-sub-html">
                      <h4 style="margin-bottom: 8px; font-size: 18px; font-weight: 600;">${image.title}</h4>
                      <p style="margin-bottom: 8px; opacity: 0.9;">${image.description || ''}</p>
                ...
                >
                  <div className="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white">
                    ...
                    {/* Image Container with dynamic height for masonry */}
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-500">
                        ...
                        {/* Optional: Add service link if available */}
                        {image.service && (
      ...
      <section className="max-w-4xl mx-auto px-4 pb-16">
        <div className="text-center py-12 bg-gradient-to-r from-pink-50 to-rose-50 rounded-2xl">
          ...
          <p className="text-base font-light text-gray-600 mb-8 max-w-2xl mx-auto">
            Ready to create your own beautiful memories? Let's discuss your photography needs 
