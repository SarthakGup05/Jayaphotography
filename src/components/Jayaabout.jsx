...
const JayaAbout = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url('/bg/lavender.jpg')`, // Replace with your image
      }}
    >
      {/* Overlay */}
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-6 text-gray-800 leading-relaxed">
                    <p className="text-lg">
                      ...
                      experience of 10 years. I am specialised in maternity and baby photography, currently working and
                      living in Lucknow. I absolutely love shooting Maternity, Baby and Newborn photography.
                    </p>

                    <p className="text-lg">
                      At our studio, we offer a wide range of baby photoshoot options that are tailored to meet your
                      specific needs and preferences. We provide both indoor and outdoor shoots with the most innovative
                      props and backdrops that will make your baby's photoshoot even more special.
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {[
                      ...
                      <div
                        key={idx}
                        className="flex items-start gap-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg"
                      >
